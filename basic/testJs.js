window.onload = function () {
  ...
  const setKorToEng_1 = [
    {
      title: "확신하는, 확실한",
      options: shuffle(["sure", "neck", "finger", "uncle"]),
      correct: "sure",
      img: "img/balloon.jpg",
    },
    {
      title: "떨어져[떨어진 곳에]",
      options: shuffle(["neck", "finger", "away", "full"]),
      correct: "away",
      img: "img/neck.jpg",
    },
    {
      title: "손가락",
      options: shuffle(["finger", "neck", "uncle", "lip"]),
      correct: "finger",
      img: "img/finger.jpg",
    },
    {
      title: "군중, 무리, 가득 메우다",
      options: shuffle(["finger", "neck", "crowd", "lip"]),
      correct: "crowd",
      img: "img/finger.jpg",
    },
    {
      title: "가장 적게, 최소로, 가장 적은[것]",
      options: shuffle(["finger", "neck", "least", "lip"]),
      correct: "least",
      img: "img/finger.jpg",
    },
    {
      title: "가구",
      options: shuffle(["finger", "neck", "mother", "furniture"]),
      correct: "furniture",
      img: "img/finger.jpg",
    },
  ];
  ...
  const setEngToKor_2 = [
    {
      title: "cousin",
      options: shuffle(["사촌", "어머니", "배부른", "마른"]),
      correct: "사촌",
      img: null,
    },
    {
      title: "vegetarian",
      options: shuffle(["사촌", "어머니", "배부른", "채식주의자"]),
      correct: "채식주의자",
      img: null,
    },
    {
      title: "leopard",
      options: shuffle(["사촌", "표범", "배부른", "마른"]),
      correct: "표범",
      img: null,
    },
    {
      title: "pour",
      options: shuffle(["사촌", "붓다[따르다]", "배부른", "마른"]),
      correct: "붓다[따르다]",
      img: null,
    },
    {
      title: "worker",
      options: shuffle(["아버지", "사촌", "작은", "노동자, 일을 하는 사람"]),
      correct: "노동자, 일을 하는 사람",
      img: null,
    },
    {
      title: "goggles",
      options: shuffle(["어머니", "고글", "목", "얇은"]),
      correct: "고글",
      img: null,
    },
  ];
  ...
  const setKorToEng_3 = [
    {
      title: "I am ___________.\n나는 배부르다",
      options: shuffle(["uncle", "full", "thin", "lip"]),
      correct: "full",
      img: null,
    },
    {
      title: "Who is that ____________?\n저 남자는 누구인가?",
      options: shuffle(["uncle", "full", "man", "lip"]),
      correct: "man",
      img: null,
    },
    {
      title: "There is a ___________ town.\n작은 마을이 있다.",
      options: shuffle(["full", "small", "finger", "neck"]),
      correct: "small",
      img: null,
    },
    {
      title:
        "You soulde learn to bruch your teeth in a _____ way.\n너는 옳은 방법으로 양치하는 것을 배워야 한다.",
      options: shuffle(["full", "correct", "finger", "neck"]),
      correct: "correct",
      img: null,
    },
    {
      title:
        "Please take the _____ out of my hamburger.\n제 햄버거에서 양상추를 빼주세요.",
      options: shuffle(["full", "thin", "lettuce", "neck"]),
      correct: "lettuce",
      img: null,
    },
    {
      title: "Look at the ________ man.\n마른 남자를 봐",
