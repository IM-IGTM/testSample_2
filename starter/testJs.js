window.onload = function () {
  ...
  const setKorToEng_1 = [
    {
      title: "-",
      options: shuffle(["lip", "neck", "fair", "small"]),
      correct: "fair",
      img: "img/fair.png",
    },
    {
      title: "-",
      options: shuffle(["lip", "neck", "uncle", "small"]),
      correct: "lip",
      img: "img/lip.jpg",
    },
    {
      title: "-",
      options: shuffle(["neck", "finger", "student", "full"]),
      correct: "student",
      img: "img/student.png",
    },
    {
      title: "-",
      options: shuffle(["neck", "lip", "thin", "full"]),
      correct: "neck",
      img: "img/neck.jpg",
    },
    {
      title: "-",
      options: shuffle(["finger", "uncle", "mother", "lip"]),
      correct: "finger",
      img: "img/finger.jpg",
    },
  ];
  ...
  const setEngToKor_2 = [
    ...
    {
      title: "move",
      options: shuffle(["아버지", "움직이다, 이동하다", "배부른", "마른"]),
      correct: "움직이다, 이동하다",
      img: null,
    },
    {
      title: "floor",
      options: shuffle(["사촌", "아버지", "어머니", "바닥, 층"]),
      correct: "바닥, 층",
      img: null,
    },
    {
      title: "father",
      options: shuffle(["아버지", "어머니", "작은", "입술"]),
      correct: "아버지",
      img: null,
    },
    {
      title: "tail",
      options: shuffle(["사촌", "꼬리", "배부른", "마른"]),
      correct: "꼬리",
      img: null,
    },
    {
      title: "trash",
      options: shuffle(["아버지", "쓰레기", "배부른", "마른"]),
      correct: "쓰레기",
      img: null,
    },
    {
      title: "mother",
      options: shuffle(["어머니", "아버지", "목", "얇은"]),
      correct: "어머니",
      img: null,
    },
  ];
  ...
  const setKorToEng_3 = [
    {
      title: "삼촌",
      options: shuffle(["uncle", "small", "thin", "lip"]),
      correct: "uncle",
      img: null,
    },
    {
      title: "배부른",
      options: shuffle(["full", "thin", "finger", "neck"]),
      correct: "full",
      img: null,
    },
    {
      title: "아이,청소년",
      options: shuffle(["kid", "thin", "finger", "neck"]),
      correct: "kid",
      img: null,
    },
    {
      title: "짓다,건축하다",
      options: shuffle(["full", "build", "finger", "neck"]),
      correct: "build",
      img: null,
    },
    {
      title: "(돈을)모으다,저축하다",
      options: shuffle(["full", "save", "finger", "neck"]),
      correct: "save",
      img: null,
    },
    {
      title: "냄새가 나다, 향",
      options: shuffle(["full", "build", "thin", "smell"]),
      correct: "smell",
      img: null,
    },
    {
      title: "작은",
      options: shuffle(["small", "full", "mother", "cousin"]),
      correct: "small",
      img: null,
    },
    {
      title: "마른",
      options: shuffle(["thin", "uncle", "father", "full"]),
      correct: "thin",
      img: null,
    },
  ];
