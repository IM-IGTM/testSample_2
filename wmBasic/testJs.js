window.onload = function () {
  ...
  const setKorToEng_1 = [
    {
      title: "키가 큰, 높은",
      options: shuffle(["tall", "neck", "finger", "small"]),
      correct: "tall",
      img: null,
    },
    {
      title: "원하다, 바라다, 소원",
      options: shuffle(["lip", "neck", "finger", "away"]),
      correct: "away",
      img: null,
    },
    {
      title: "알아내다, 발견하다",
      options: shuffle(["lip", "find out", "finger", "small"]),
      correct: "find out",
      img: null,
    },
    {
      title: "빵집, 제과점",
      options: shuffle(["lip", "bakery", "uncle", "small"]),
      correct: "bakery",
      img: null,
    },
    {
      title: "소스, 양념",
      options: shuffle(["neck", "sauce", "lip", "full"]),
      correct: "sauce",
      img: null,
    },
    {
      title: "꿈, 꿈을 꾸다",
      options: shuffle(["dream", "uncle", "mother", "lip"]),
      correct: "dream",
      img: null,
    },
  ];
  ...
  const setEngToKor_2 = [
    {
      title: "promise",
      options: shuffle(["사촌", "약속하다, 약속", "어머니", "마른"]),
      correct: "약속하다, 약속",
      img: null,
    },
    {
      title: "taste",
      options: shuffle(["사촌", "아버지", "맛이 나다, 맛", "마른"]),
      correct: "맛이 나다, 맛",
      img: null,
    },
    {
    ...
    {
      title: "stop by",
      options: shuffle(["아버지", "~에 잠시 들르다", "배부른", "마른"]),
      correct: "~에 잠시 들르다",
      img: null,
    },
    {
      title: "comfortable",
      options: shuffle(["편안한, 쾌적한", "어머니", "배부른", "마른"]),
      correct: "편안한, 쾌적한",
      img: null,
    },
    {
      ...
      correct: "오른쪽, 오른쪽의, 오른쪽으로",
      img: null,
    },
    {
      title: "absent",
      options: shuffle(["결석한, (자리에) 없는", "사촌", "목", "얇은"]),
      correct: "결석한, (자리에) 없는",
      img: null,
    },
  ];
  ...
  const setKorToEng_3 = [
    {
      ...
      options: shuffle(["uncle", "full", "small", "lip"]),
      correct: "full",
      img: null,
    },
    {
      title: "Who is that ____________?\n저 남자는 누구인가?",
      options: shuffle(["man", "thin", "finger", "neck"]),
      correct: "man",
      img: null,
    },
    {
    ...
    },
    {
      ...
      options: shuffle(["correct", "thin", "finger", "neck"]),
      correct: "correct",
      img: null,
    },
    {
      ...
      options: shuffle(["thin", "finger", "lettuce"]),
      correct: "lettuce",
      img: null,
    },
    {
