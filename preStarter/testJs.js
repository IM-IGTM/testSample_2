window.onload = function () {
  ...
  const setKorToEng_1 = [
    {
      title: "-",
      options: shuffle(["lip", "neck", "balloon", "small"]),
      correct: "balloon",
      img: "img/balloon.png",
    },
    {
      title: "-",
      options: shuffle(["neck", "finger", "thin", "full"]),
      correct: "neck",
      img: "img/neck.jpg",
    },
    {
      title: "-",
      options: shuffle(["finger", "circle", "mother", "lip"]),
      correct: "circle",
      img: "img/circle.png",
    },
    {
      title: "-",
      options: shuffle(["island", "neck", "finger", "uncle"]),
      correct: "island",
      img: "img/island.png",
    },
    {
      title: "-",
      options: shuffle(["lip", "neck", "finger", "small"]),
      correct: "lip",
      img: "img/lip.jpg",
    },
  ];
  ...
  const setEngToKor_2 = [
    ...
    {
      title: "favorite",
      options: shuffle(["가장 좋아하는", "어머니", "작은", "입술"]),
      correct: "가장 좋아하는",
      img: null,
    },
    {
      title: "bowl",
      options: shuffle(["그릇", "사촌", "어머니", "작은"]),
      correct: "그릇",
      img: null,
    },
    {
      title: "tennis",
      options: shuffle(["사촌", "어머니", "테니스", "입술"]),
      correct: "테니스",
      img: null,
    },
    {
      title: "crayon",
      options: shuffle(["사촌", "크레용", "작은", "입술"]),
      correct: "크레용",
      img: null,
    },
    {
      title: "teeth",
      options: shuffle(["아버지", "사촌", "이", "입술"]),
      correct: "이",
      img: null,
    },
    {
      title: "toe",
      options: shuffle(["아버지", "크레용", "작은", "발가락"]),
      correct: "발가락",
      img: null,
    },
    {
  ...
  const setKorToEng_3 = [
    {
      title: "접시",
      options: shuffle(["uncle", "dish", "thin", "lip"]),
      correct: "dish",
      img: null,
    },
    {
      title: "요요",
      options: shuffle(["yo-yo", "small", "thin", "lip"]),
      correct: "yo-yo",
      img: null,
    },
    {
    ...
    {
      title: "강",
      options: shuffle(["full", "thin", "river", "neck"]),
      correct: "river",
      img: null,
    },
    {
    ...
    {
      title: "마른",
      options: shuffle(["thin", "small", "uncle", "father"]),
      correct: "thin",
      img: null,
    },
  ];
